...
#ifndef RC_INTERFACE_ACI_COOPERATIVE_H_
#define RC_INTERFACE_ACI_COOPERATIVE_H_

#include <mav_control_interface/rc_interface.h>

namespace mav_control_interface {

class RcInterfaceAciCooperative : public RcInterfaceBase {
 public:
  static constexpr float STICK_DEADZONE = 0.1;

  RcInterfaceAciCooperative(const ros::NodeHandle& nh);
