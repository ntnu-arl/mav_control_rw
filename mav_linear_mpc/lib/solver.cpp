/* Produced by CVXGEN, 2019-01-22 17:28:10 -0500.  */
...
void setup_pointers(void) {
  ...
  vars.x_8 = work.x + 153;
  vars.x_9 = work.x + 159;
  vars.x_10 = work.x + 165;
  vars.x_11 = work.x + 171;
  vars.x_12 = work.x + 177;
  vars.x_13 = work.x + 183;
  vars.x_14 = work.x + 189;
  vars.x_15 = work.x + 195;
  vars.x_16 = work.x + 201;
  vars.x_17 = work.x + 207;
  vars.x_18 = work.x + 213;
  vars.x_19 = work.x + 219;
}
...
void fillrhs_cc(void) {
  ...
  double minval;
  r2 = work.rhs + 225;
  ds_aff = work.lhs_aff + 225;
  dz_aff = work.lhs_aff + 339;
  mu = 0;
  for (i = 0; i < 114; i++)
